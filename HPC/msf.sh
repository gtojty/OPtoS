...
if [ "$#" -eq 3 ]; then
	...
	echo $1 | time ./OtoS -runmode $2 -iter $4 -rep $5 -iter_stos $6 -rep_stos $7 -samp $8 -met $9 > $1$3.log 	
elif [ "$#" -eq 10 ]; then
	echo $1 | time ./OtoS -runmode $2 -iter $4 -rep $5 -iter_stos $6 -rep_stos $7 -samp $8 -met $9 -vthres $10 > $1$3.log 	
else
 	echo $1 | time ./OtoS -runmode $2 -iter $4 -rep $5 -iter_stos $6 -rep_stos $7 -samp $8 -met $9 -vthres $10 -recvec $11 > $1$3.log
fi